...
2. Justificar com base na estrutura do código - A arquitetura usada é MVC ( Model, View, Controller )
3. Identificar a classe que deve ser alterada - class ServicoCarrinho
